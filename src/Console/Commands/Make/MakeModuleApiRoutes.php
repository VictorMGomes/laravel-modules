...
class MakeModuleApiRoutes extends Command
{
    protected $signature = 'module:make-api-routes {module : The name of the module}';

    protected $description = 'Create api routes file for a Module';

    public function handle(): int
    {
        return $this->generateRouteFile('api');
    }
