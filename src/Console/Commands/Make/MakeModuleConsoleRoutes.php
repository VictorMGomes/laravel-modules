...
class MakeModuleConsoleRoutes extends Command
{
    protected $signature = 'module:make-console-routes {module : The name of the module}';

    protected $description = 'Create console routes file for a Module';

    public function handle(): int
    {
        return $this->generateRouteFile('console');
    }
