...
class MakeModuleWebRoutes extends Command
{
    protected $signature = 'module:make-web-routes {module : The name of the module}';

    protected $description = 'Create web routes file for a Module';

    public function handle(): int
    {
        return $this->generateRouteFile('web');
    }
